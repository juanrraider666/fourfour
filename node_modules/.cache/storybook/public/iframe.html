    ...
    console.warn('unable to connect to top frame for connecting dev tools');
      ...
      #storybook-docs[hidden] {
        display: none !important;
            ...
            window['STORIES'] = [{"titlePrefix":"","directory":"./web","files":"**/*.mdx","importPathMatcher":"^\\.[\\\\/](?:web(?:[\\\\/](?!\\.)(?:(?:(?!(?:^|[\\\\/])\\.).)*?)[\\\\/]|[\\\\/]|$)(?!\\.)(?=.)[^\\\\/]*?\\.mdx)$"},{"titlePrefix":"","directory":"./web","files":"**/*.stories.@(json|yaml|yml)","importPathMatcher":"^\\.[\\\\/](?:web(?:[\\\\/](?!\\.)(?:(?:(?!(?:^|[\\\\/])\\.).)*?)[\\\\/]|[\\\\/]|$)(?!\\.)(?=.)[^\\\\/]*?\\.stories\\.(json|yaml|yml))$"}];
      ...
      import './vendors-node_modules_storybook_addon-essentials_dist_actions_preview_js-node_modules_storyboo-fcdd2a.iframe.bundle.js';
